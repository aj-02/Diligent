...
*    DATA : wa_j_1imovend TYPE j_1imovend.  "#EC CI_USAGE_OK[2877717]
    DATA : wa_j_1imovend TYPE lfa1.  "#EC CI_USAGE_OK[2877717]
...
*  PERFORM bdc_field       USING 'J_1IMOVEND-LIFNR(01)'
  PERFORM bdc_field       USING 'LFA1-LIFNR(01)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
                                ist_vend-vend-lifnr.
*--- BEGIN OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*  PERFORM bdc_field       USING 'J_1IMOVEND-J_1ICSTNO(01)'
  PERFORM bdc_field       USING 'LFA1-J_1ICSTNO(01)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
                                ist_vend-vend-stcd2.
*--- BEGIN OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*  PERFORM bdc_field       USING 'J_1IMOVEND-J_1ILSTNO(01)'
  PERFORM bdc_field       USING 'LFA1-J_1ILSTNO(01)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
                                ist_vend-vend-stcd1.
...
*  PERFORM bdc_field       USING 'J_1IMOVEND-AEDAT(01)'
  PERFORM bdc_field       USING 'LFA1-AEDAT(01)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*                                  sy-datum.                  "-rk003
                                l_aedat.
*--- BEGIN OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*  PERFORM bdc_field       USING 'J_1IMOVEND-USNAM(01)'
  PERFORM bdc_field       USING 'LFA1-USNAM(01)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
                                sy-uname.
*--- BEGIN OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*  PERFORM bdc_field       USING 'J_1IMOVEND-J_1ISERN(01)'
  PERFORM bdc_field       USING 'LFA1-J_1ISERN(01)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
...
*    PERFORM bdc_field       USING 'J_1IMOVEND-LIFNR(02)'
    PERFORM bdc_field       USING 'LFA1-LIFNR(02)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
                                  ist_vend-vend-lifnr.
*--- BEGIN OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*    PERFORM bdc_field       USING 'J_1IMOVEND-J_1ICSTNO(02)'
    PERFORM bdc_field       USING 'LFA1-J_1ICSTNO(02)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
                                  ist_vend-vend-stcd2.
*--- BEGIN OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*    PERFORM bdc_field       USING 'J_1IMOVEND-J_1ILSTNO(02)'
    PERFORM bdc_field       USING 'LFA1-J_1ILSTNO(02)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
                                  ist_vend-vend-stcd1.
*--- BEGIN OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*    PERFORM bdc_field       USING 'J_1IMOVEND-J_1IPANNO(02)'
    PERFORM bdc_field       USING 'LFA1-J_1IPANNO(02)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
                                  ist_vend-vend-j_1ipanno.
*--- BEGIN OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*    PERFORM bdc_field       USING 'J_1IMOVEND-AEDAT(02)'
    PERFORM bdc_field       USING 'LFA1-AEDAT(02)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*                                  sy-datum.                  "-rk003
                                  l_aedat.
*--- BEGIN OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*    PERFORM bdc_field       USING 'J_1IMOVEND-USNAM(02)'
    PERFORM bdc_field       USING 'LFA1-USNAM(02)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
                                  sy-uname.
*--- BEGIN OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
*    PERFORM bdc_field       USING 'J_1IMOVEND-J_1ISERN(02)'
    PERFORM bdc_field       USING 'LFA1-J_1ISERN(02)'
*--- END OF CHANGE BY SAP_ABAP 08.08.2026 FOR ATC ---
                                  ist_vend-vend-j_1isern.
