...
DATA: lv_first TYPE abap_bool VALUE abap_true.
  SELECT *
   ...
   LOOP AT gt_amort_sch INTO DATA(Ls_amort_sch).

* Capture first G/L only
    IF lv_first = abap_true.
      MOVE-CORRESPONDING ls_amort_sch TO gs_amort_sch.
      LV_FIRST = ABAP_FALSE.
    ELSE.
      gs_amort_sch-instl_amt = gs_amort_sch-instl_amt + Ls_amort_sch-instl_amt.
    ENDIF.
...
FORM build_header USING iv_text TYPE char25.
  ...
  ls_header-ref_doc_no = 'Sec 42 Amort'.
