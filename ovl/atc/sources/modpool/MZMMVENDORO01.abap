...
********CAB_AJIT 24.01.2006 Request No  length icreased to 10 chars ****
    ...
    LOOP AT ist_vendor.
      WRITE :/1(1) sy-vline,2(10) ist_vendor-reqno COLOR 3,
              12(1) sy-vline,13(30) ist_vendor-name1 COLOR 3,
              44(1) sy-vline,45(10) ist_vendor-name2 COLOR 3,
              56(1) sy-vline,57(20) ist_vendor-ort01 COLOR 3,
...
********CAB_AJIT 24.01.2006 Request No  length icreased to 10 chars ****
    ...
    ULINE /1(81).
    LOOP AT ist_vendor.
      WRITE :/1(1)  sy-vline, 2(4)  ist_vendor-seqno COLOR 3,
             6(1)  sy-vline,  7(30)  ist_vendor-name1 COLOR 3,
             37(1) sy-vline,  38(10) ist_vendor-name2 COLOR 3,
             48(1) sy-vline,  49(20) ist_vendor-ort01 COLOR 3,
             69(1) sy-vline,  70(10) ist_vendor-reqno COLOR 3,
