...
*
*1) Changes in INCLUDE MZMMPREPROLE2F01.
*2) Changes in INCLUDE MZMMPREPROLE2TOP.
************************************************************************
INCLUDE MZMMPREPROLE2TOP.
*INCLUDE MZMMPREPROLE3TOP.

INCLUDE MZMMPREPROLE2O01.
*INCLUDE MZMMPREPROLE3O01.
.
INCLUDE MZMMPREPROLE2I01.
*INCLUDE MZMMPREPROLE3I01.
.
INCLUDE MZMMPREPROLE2F01.
...
MODULE STATUS_0100 OUTPUT.
  ...
  SET PF-STATUS 'OPTNS2' excluding it_tab.

  SET TITLEBAR 'PREP_TITLE' with ': Administration '.
  ...
  CASE old_ok_code.
    ...
    when 'CHANGE'.
      ...
      loop at screen.
        ...
        if ( screen-name = 'ZMM_PREP_ROLEREQ-STATUS' ).
          screen-input = 1.
          modify screen.
        endif.
        ...
        if screen-name = 'ZMM_PREP_ROLEREQ-USERID'  or
           screen-name = 'ZMM_PREP_ROLEREQ-TELNO'   or
           screen-name = 'ZMM_PREP_ROLEREQ-CORR'    or
           screen-name = 'ZMM_PREP_ROLEREQ-RSN_CODE' or
           screen-name = 'ZMM_PREP_ROLEREQ-DISC_MM_FLAG'.
           screen-input = 0.
           modify screen.
        endif.
...
*          endif.
        ...
        if sy-tcode = 'ZMM_ARMS_ADMN' and
              screen-name = 'ZMM_PREP_ROLEREI-REJ_FL' and
              old_ok_code = 'CHANGE' and ZMM_PREP_ROLEREI-REJ_FL = 'F'.
          screen-input = 1.
          modify screen.
        endif.
        ...
        if sy-tcode = 'ZMM_ARMS_ADMN' and
             ( screen-name = 'ZMM_PREP_ROLEREI-ROLE_REQUEST' or
              screen-name = 'ZMM_PREP_ROLEREI-PLANT'         or
              screen-name = 'ZMM_PREP_ROLEREI-GRP'           or
              screen-name = 'ZMM_PREP_ROLEREI-RECEIPT_LOC'   or
              screen-name = 'ZMM_PREP_ROLEREI-APPROVER'      or
              screen-name = 'ZMM_PREP_ROLEREI-SLOC'          or
              screen-name = 'G_TABCTRL100_WA-FLAG' ).
          screen-input = 1.
          modify screen.
        else.
          screen-input = 0.
...
*              endif.
            ...
            if sy-tcode = 'ZMM_ARMS_ADMN' and
              ...
              screen-name = 'ZMM_PREP_ROLEREI-RECEIPT_LOC'   or
              screen-name = 'ZMM_PREP_ROLEREI-APPROVER'      or
              screen-name = 'ZMM_PREP_ROLEREI-SLOC' ).
              screen-input = 1.
              modify screen.
            endif.
...
* 06/10/2008      <RD1K960036>    SAB_SUMODH
*
*  1) Length Specification is Not Allowed for TYPE I. (Line 267)
************************************************************************
...
zmm_prep_usrcont, ZMM_PREP_EX_APP, soodk, sood5,
