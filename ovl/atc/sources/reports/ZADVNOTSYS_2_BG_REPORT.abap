*--- MAIN PROGRAM: ZADVNOTSYS_2_BG_REPORT ---*
*&---------------------------------------------------------------------*
*& Report  ZADVNOTSYS_2_BG_REPORT
*&
* Title      :  Advance Notification System - BG/ LC Report           *
*                                                                     *
...
*                                                                     *
*                                                                     *
* Description: This program will generate BG report for Advance       *
*              Notification System.                                   *
*                                                                     *
* Tran. Code : ZMMANSREPORT_BG                                        *
*
*&---------------------------------------------------------------------*
*&
*&
...
FORM POPULATE_EMAIL_MESSAGE_BODY .
  ...
  L_TEXT2 = crlf.
  L_TEXT3 = 'The Advance Notification System has detected that the validity of EMD/SD for the Purchase documents created/released by you will expire on'.
  L_EDD = sy-datum + 15.
