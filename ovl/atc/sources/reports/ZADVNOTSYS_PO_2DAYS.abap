*--- MAIN PROGRAM: ZADVNOTSYS_PO_2DAYS ---*
*&---------------------------------------------------------------------*
*& Report  ZADVNOTSYS
*&
* Title      : Advance Notification System for PO delivery date-2days *
*                                                                     *
...
*              about approaching delivery dates of material POs-2 days*
*                                                                     *
* Tran. Code : ZMM_ANS_PO2
*&---------------------------------------------------------------------*
*&
*&
*&---------------------------------------------------------------------*

REPORT  ZADVNOTSYS_PO_2DAYS.
*********Data declaration***********
...
*        NL = CL_ABAP_CHAR_UTILITIES=>NEWLINE.
  ...
  L_TEXT2 = crlf.
  L_TEXT3 = 'A gentle reminder from the Advance Notification System. The delivery of a few Purchase Orders released by you is scheduled on'.
  L_EDD = sy-datum + 2.
