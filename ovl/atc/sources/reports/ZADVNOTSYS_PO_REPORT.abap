*--- MAIN PROGRAM: ZADVNOTSYS_PO_REPORT ---*
*&---------------------------------------------------------------------*
*& Report  ZADVNOTSYS_PO_REPORT
*&
* Title      : Advance Notification System - Report                   *
*                                                                     *
...
*                                                                     *
*                                                                     *
* Description: This program will generate PO report for Advance       *
*              Notification System                                    *
*                                                                     *
* Tran. Code : ZMMANSREPORT_PO
*&---------------------------------------------------------------------*
*&
*&
*&---------------------------------------------------------------------*
...
parameters: P_DAY type zint_pos . "  obligatory.
...
***COMMENTED FOR REPORTING TRANSACTION
